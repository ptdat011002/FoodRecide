...
fetchData(null, data => {
    ...
    <div class="detail-content">
        <div class="title-wrapper">
            ...
            ${isSaved ? "saved" : "removed"}" onclick="saveRecipe(this,'${recipeId}')">
        ...
        <a href="${url}" target="_blank" class="btn btn-secondary has-state has-icon">
        <span class="material-symbols-outlined">link</span>
        <span class="label-large save-text">Link</span>
        </a>
    </div>
